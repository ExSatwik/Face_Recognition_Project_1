...
embedding_file = f"representations_{model_key}.pkl"

# ---- Thresholds ----
thresholds = {
    "Facenet": {"cosine": 0.4, "euclidean": 10, "euclidean_l2": 0.9},
    "VGG-Face": {"cosine": 0.3, "euclidean": 15, "euclidean_l2": 1.2},
    "ArcFace": {"cosine": 0.3, "euclidean": 10, "euclidean_l2": 0.9},
